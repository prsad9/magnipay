...
const categories = [
  ...
  },
  {
    ...
    services: [
      ...
      { icon: Globe, title: "Payment Gateway", desc: "Unified online payment gateway supporting cards, net banking, UPI, and wallets with instant settlement.", greeting: "Thanks for choosing our Payment Gateway! Support all payment methods with PCI compliance, fraud detection, and instant settlements.", longDesc: "Integrate our powerful payment gateway to accept all payment methods on your e-commerce platform. Support for credit/debit cards, net banking, UPI, mobile wallets, and Buy Now Pay Later options. We handle PCI compliance, fraud detection, and offer instant settlements directly to your bank account with detailed reporting." },
  ...
  },
  {
    ...
    services: [
      ...
      { icon: ShoppingCart, title: "Buy Now Pay Later", desc: "Flexible payment plans for large purchases. Split bills into manageable installments with zero interest.", greeting: "Thanks for choosing Buy Now Pay Later! Zero interest EMIs with flexible 3-12 month tenure options.", longDesc: "Spread your purchases into manageable monthly installments with zero interest. No hidden charges or processing fees on approved transactions. Quick approval process using alternative credit scoring, flexible tenure options from 3 to 12 months, and easy EMI management from your account." },
    ],
  },
];
      ...
      <AnimatePresence>
        {activeModal && (
          <>
            ...
            >
              <div className="max-h-[90vh] overflow-y-auto w-[90%] max-w-3xl p-8 sm:p-12 rounded-3xl 
              ...
              >
                <button
                  onClick={() => setActiveModal(null)}
                  className="absolute top-6 right-6 p-2 rounded-lg hover:bg-muted background-transition transition-colors"
                >
                  <X size={20} />
                </button>
                ...
                <div className="inline-flex p-4 rounded-xl bg-gradient-to-br from-primary to-accent mb-6">
                  <activeModal.icon size={28} className="text-white" />
                </div>
